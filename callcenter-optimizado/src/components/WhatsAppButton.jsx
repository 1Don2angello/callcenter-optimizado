export default function WhatsAppButton({ telefono, nombre, tipo }) {
  ...
  saludo: {
    ...
    img: "https://drive.google.com/file/d/1fCJKsrp523xsSRPVF7c_Yt3MLGy0mziZ/view?usp=sharing"
  },
  seguimiento: {
    texto: () =>
    ...
    img: "https://drive.google.com/file/d/1lOcENuYtoe9X8jKhF0ukxTvO3mHrEY-e/view?usp=sharing"
  }
};
